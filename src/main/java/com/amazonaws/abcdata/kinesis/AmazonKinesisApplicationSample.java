...
public final class AmazonKinesisApplicationSample {
     ...
     *      (/home/<username>/.aws/credentials) where the sample code will load the
     *      credentials from.
    ...
    public static final String SAMPLE_APPLICATION_STREAM_NAME = "ABCSpikePoleData";

    private static final String SAMPLE_APPLICATION_NAME = "AbcDataKinesisApplication";
    ...
    private static void init() {
        ...
        try {
            ...
            throw new AmazonClientException("Cannot load the credentials from the credential profiles file. "
                    ...
                    + "location (/home/singhs/.aws/credentials), and is in valid format.", e);
        }
    }
